<?php 
    if(!empty($_REQUEST['vat'])){
        ...
        $sql = "SELECT * FROM appointment WHERE vat_client = '$cl'";
        ...
        if($result -> rowCount() > 0){
            ...
            for($x = 0; $x < sizeof($doctor); $x++){
                ...
                $sqll = "SELECT * FROM consultation WHERE vat_doctor = '$doctor[$x]' AND date_timestamp = '$time[$x]'";
